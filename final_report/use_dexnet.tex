...
The results are shown in \figref{fig:gqcnn_results}. 
After a few time steps the training and validation accuracy achieve 60\%, which is also what our test set reported. 
The confusion matrix in \figref{fig:confusion_new_gqcnn}, shows our improved accuracy and that we tend to over-predict positive labels. 
